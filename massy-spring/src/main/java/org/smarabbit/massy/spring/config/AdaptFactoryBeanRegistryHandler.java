...
public class AdaptFactoryBeanRegistryHandler implements BeanRegistryHandler {
	...
	public Registration register(String beanName,
		...
		if (service instanceof AdaptFactory){
			AdaptFactoryRegistry  registry = MassyUtils.getDefaultContext()
					.getService(AdaptFactoryRegistry.class);
			return registry.register(ad.getAdaptType(), (AdaptFactory)service, null);
		}
