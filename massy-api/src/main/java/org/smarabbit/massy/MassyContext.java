 ...
 * {@link org.smarabbit.massy.service.service.ServiceRegistry}提供服务注册和查找，
...
public interface MassyContext extends Descriptable{
	 ...
	 * <br>
	 * 如果期望方法不抛出异常，请使用{@link org.smarabbit.massy.service.service.ServiceRegistry#findService(Class)}方法。
	 * @param serviceType 
	 * 		服务类型，非空
	 * @return 
	 * 		找到的服务实例，不能返回null.
	 ...
	 * {@link org.smarabbit.massy.service.service.ServiceRegistry#findService(Class, org.smarabbit.massy.spec.Specification)}
	 * 方法查找服务。
	 * <br>
	 * 如果期望方法不抛出异常，请使用{@link org.smarabbit.massy.service.service.ServiceRegistry#findService(Class, String)}方法。
	 * @param serviceType
	 * 		服务类型，非空
	 * @param alias
	 * 		服务别名，非空
